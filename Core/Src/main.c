...
//		}
	  if(USART2_RX_STA & 0x8000)
	  {
		  ...
		  if(USART2_RX_BUF[0] == '1')
		  {
			  McNhamCar.FrontLeftWheel.DesireSpeed = 999;
			  McNhamCar.FrontRightWheel.DesireSpeed = 999;
			  McNhamCar.RearLeftWheel.DesireSpeed = 999;
			  McNhamCar.RearRightWheel.DesireSpeed = 999;
		  }
		  if (USART2_RX_BUF[0] == '2')
		  {
			  McNhamCar.FrontLeftWheel.DesireSpeed = -999;
		  ...
		  if (USART2_RX_BUF[0] == '6')
		  {
			  if (mask == 0)
			  {
				  McNhamCar.FrontLeftWheel.DesireSpeed = 0;
				  McNhamCar.FrontRightWheel.DesireSpeed = 0;
				  McNhamCar.RearLeftWheel.DesireSpeed = 0;
				  McNhamCar.RearRightWheel.DesireSpeed = 0;
				  L298N_SetDirection(AllWheel, Wheel_Stop);
				  mask = 1;
			  }
			  else
...
//		Rpm_Vel[3] = __HAL_TIM_GET_COUNTER(&htim5) - 30000;
		...
		McNhamCar.RearRightWheel.CurrentSpeed = __HAL_TIM_GET_COUNTER(&htim5) - 30000;
...
//		printf(" 4:%6d \n\r", McNhamCar.RearRightWheel.ControlPluse);
		
//		printf(" 1:%6d \n\r", McNhamCar.FrontLeftWheel.CurrentSpeed);
